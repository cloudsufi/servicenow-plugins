...
public class ServiceNowSinkOutputFormatProviderTest {
  ...
  @Test
  public void testGetOutputFormatConfiguration() throws OAuthProblemException {
    Configuration configuration = new Configuration();
    ServiceNowOutputFormatProvider serviceNowOutputFormatProvider = new ServiceNowOutputFormatProvider(configuration);
    Assert.assertEquals(241, serviceNowOutputFormatProvider.getOutputFormatConfiguration().size());
  }
}
